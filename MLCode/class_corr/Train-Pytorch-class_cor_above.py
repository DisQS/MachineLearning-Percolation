...
myCSV='/home/p/phrhmb/Perco/Data_csv/data_pkl_100_above_3077_5_classes_new_corr.csv'#data_pkl_'+str(size)+'_'+str(size_samp)+'.csv'
##############################################################################################
dataname='Perco-data-bw-very-hres-corr-above-pc-L'+str(size)+'-'+str(nimages)+'-s'+str(size)+'_3077'+'_s'+str(myseed)
...
cm_path_test=savepath+method+'_'+dataname+'cm_test.txt'
