...
myCSV='/home/p/phrhmb/Perco/Data_csv/data_pkl_100_below_3560_6_classes_new_corr.csv'#data_pkl_'+str(size)+'_'+str(size_samp)+'.csv'
##################################################################################################
dataname='Perco-data-bw-very-hres-corr-below-pc-L'+str(size)+'-'+str(nimages)+'-s'+str(size)+'_3560'+'_s'+str(myseed)
