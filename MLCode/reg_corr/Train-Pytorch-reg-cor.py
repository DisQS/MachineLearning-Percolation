...
import re
import sys                                           
sys.path.insert(0, '/home/physics/phsht/Perco_data/MLCode')
from MLtools import *                           
#####################################################################
print(sys.argv)
if ( len(sys.argv) == 8 ):
...
dataname='Perco-data-reg-bw-int-corr-L'+str(size)+'_'+str(size_samp)+'_s'+str(myseed)
#datapath='../L'+str(size)+'' 
...
reg_prediction_cor(val,model,size,myseed,whole_dataset,savepath,nb_classes=number_classes,data_type='val')
print('--> finished!')
