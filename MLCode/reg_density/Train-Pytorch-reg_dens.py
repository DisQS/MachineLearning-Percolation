...
myTESTPATH='../../../Data/L'+str(size)+'_test_1000'
myCSV_TEST='../../../Data_csv/data_pkl_'+str(size)+'_test_1000_1000.csv'
myCSV='../../../Data_csv/data_pkl_'+str(size)+'_'+str(size_samp)+'_shuffled_with_p_int.csv'
...
whole_dataset =Dataset_csv_pkl_reg(csv_file=myCSV,
                                     root_dir=myDATAPATH,size=size, classe_type='density', array_type='bw',type_file='symlink',transform=transforms.ToTensor())
...
#reg_prediction_dens(val,size,model,myseed,savepath,nb_classes=number_classes,data_type='redone_val')
#reg_prediction_dens(train,size,model,myseed,savepath,nb_classes=number_classes,data_type='redone_whole')
reg_prediction_dens(test,size,model,myseed,savepath,nb_classes=number_classes,data_type='test_redo')
