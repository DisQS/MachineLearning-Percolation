...
# everyone
myDATAPATH='/home/p/phrhmb/Perco/Data/'+'L'+str(size)+'_rename/L'+str(size)+'_rename/'
myCSV='/home/p/phrhmb/Perco/Data_csv/data_100_10000_renamed_shuffled_with_p.csv'
myTESTPATH='/home/p/phrhmb/Perco/Data/'+'L'+str(size)+'_test_1000/'
myCSV_TEST='/home/p/phrhmb/Perco/Data_csv/'+'data_pkl_100_test_1000_1000.csv'
...
type_file='symlink',transform=transforms.ToTensor())
...
np.savetxt(savepath+method+'_'+dataname+'cm_test_redo.txt',cm,fmt='%d',header=str_classes_names)

print('--> computing/saving classification outputs')
classification_prediction_dens(test,size,model,whole_dataset,savepath,31,'test_redo')

csv_file=savepath+'predictions_class_density_bw_v_h_res_'+str(size)+'_'+str(myseed)+'_test_redo.csv'
